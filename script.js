...
function startYourJourney() {
    ...
    let partA = prompt("Do you want to (1) poison the rats or give them (2) pizza?")
    if(partA == "1") {
      ...
      "Rats are in public less and are eating more pizza at home.")
         let partC = prompt("You move to next phase of Ratmeggedon, will you (1) lure the rats outside new york to the Hudson Valley or (2) give them cup noodles? or IDK")
          if(partC=="1"){
  ...
  return prompt("The rats are laughing, move to plan b."+
  "Do you want to (a)give them needles for little rat duels or (b) introduce gambling")
